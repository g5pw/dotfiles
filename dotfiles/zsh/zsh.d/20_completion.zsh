...
zstyle ':completion::complete:(v|vi|vim|nvim|scmpuff|emacs|mate|subl):*' ignored-patterns '*.(o|a|so|aux|dvi|log|swp|fig|bbl|blg|bst|idx|ind|out|toc|class|pdf|ps|pyc|zwc)'
