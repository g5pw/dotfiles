...
zstyle ':completion::complete:(rm|vi|vim|nvim|scmpuff|diff|mv):*' ignore-line true
...
zstyle ':completion::complete:(v|vi|vim|nvim|scmpuff|emacs|mate|subl):*' ignored-patterns '*.(o|a|so|aux|dvi|lock|log|swp|fig|bbl|blg|bst|idx|ind|out|toc|class|pdf|ps|pyc|zwc)'
